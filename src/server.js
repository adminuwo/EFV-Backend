...
const serveDynConfig = (req, res) => {
    ...
    // Check if this is a Cloud Run environment to auto-resolve URL if missing
    let finalUrl = apiUrl;
    if (!apiUrl && process.env.K_SERVICE) {
        finalUrl = `https://${process.env.K_SERVICE}-743928421487.asia-south1.run.app`;
    }
